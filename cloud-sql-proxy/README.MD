...
1. Using the `gcloud` command to create a new 2nd generation Cloud SQL intance (or use a previously created instance). You must enable the [Cloud SQL API](https://pantheon.corp.google.com/apis/library/sqladmin.googleapis.com/?q=sql) for your project.

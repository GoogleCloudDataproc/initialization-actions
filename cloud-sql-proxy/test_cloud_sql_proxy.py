...
class CloudSqlProxyTestCase(DataprocTestCase):
  ...
  def verify_mysql(self, configuration):
  ...
  def verify_postgresql(self, configuration):
    ...
    self.createCluster(
      configuration, self.INIT_ACTIONS, scopes='sql-admin')

...
yarn:
  environment: evironment://${DASK_CONDA_ENV}
...
function install_dask() {
  ...
  if [[ "${DASK_RUNTIME}" == 'yarn' ]]; then
    # as of 20240810 dask-yarn is not working and I have disabled the
    # tests.  I am proposing a fix but have not exercised it.

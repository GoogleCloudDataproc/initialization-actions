...
* By default, Flink is installed from a prebuilt apt package.  If you want to install from a snapshot instead, set the cluster metadata key `flink-use-snapshot` to `true` when creating the cluster.

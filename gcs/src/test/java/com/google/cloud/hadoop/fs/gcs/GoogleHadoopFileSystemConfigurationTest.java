      ...
      new HashMap<String, Object>() {
        {
          ...
          put("fs.gs.enable.service.account.auth", null);
          put("fs.gs.service.account.auth.email", null);
          put("fs.gs.service.account.auth.keyfile", null);
          put("fs.gs.client.id", null);
          put("fs.gs.client.secret", null);

...
/** Unit tests for IndirectBigQueryOutputFormat. */
...
public class IndirectBigQueryOutputFormatTest {
  ...
  private IndirectBigQueryOutputFormatWrapper<Text, Text> outputFormat;
  ...
  public void setUp() throws IOException {
    ...
    outputFormat = new IndirectBigQueryOutputFormatWrapper<Text, Text>();
  ...
  /** Test the correct delegate is returned. */
  @Test
  ...
  @Test
  public void testGetCommitter() throws IOException {
    // Setup configuration.
    FileOutputFormat.setOutputPath(job, GCS_TEMP_PATH);

    IndirectBigQueryOutputCommitterWrapper committer =
        (IndirectBigQueryOutputCommitterWrapper)
            outputFormat.getOutputCommitter(mockTaskAttemptContext);

    // TODO(user): Find out what caused type error
